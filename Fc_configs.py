config = {
    "consumer_settings": {
        ...
        "group.id": 'ConssingmentAndbookingDetails',
    ...
    "Booking_Details_Final_Schema": [
        'foc_cnno', 'foc_cpdp_code', 'record_updated_date', 'foc_bkcusttype_code', 'foc_bkcust_code', 'foc_bookchannel',
        'foc_bkdocument_code', 'foc_Booked_Wt', 'foc_Vol_Wt', 'foc_Billed_Wt', 'foc_pcs', 'foc_nop', 'foc_booking_app'
    ],

    "Adress_Details_Final_Schema": [
        'foc_cnno', 'record_updated_date', 'foc_receiver_name', 'foc_receiver_phno', 'foc_receiver_address', 'foc_receiver_city', 
    ...
    "Payment_Details_Final_Schema": [
        'foc_cnno', 'record_updated_date', 'foc_vas_prod_code'
    ],

    "Consignment_History_Final_Schema": [
        'foc_cnno', 'record_updated_date', 'foc_non_dlv_attempts', 'foc_rto_non_dlv_attempts'
    ],
